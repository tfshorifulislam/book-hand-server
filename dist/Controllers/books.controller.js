...
export const getBooksController = async (req, res) => {
    try {
        ...
        const cacheUser = typeof userId === "string" ? userId : "guest";
        ...
        if (cachedData) {
            ...
            return res.status(200).json({
                ...
                data: cachedData.listings,
                pagination: cachedData.pagination,
            });
        }
        // CACHE MISS
        console.log("CACHE MISS:", cacheKey);
        const result = await getAllBookListings(page, limit, search, typeof userId === "string" ? userId : undefined);
        // Save to Redis
